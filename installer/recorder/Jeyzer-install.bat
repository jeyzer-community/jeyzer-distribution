...
rem Supported Java versions : 7, 8, 11 and 17
...
set PATH=C:\Dev\programs\Java\Oracle\jre-7u80-windows-x64\jre1.7.0_80\bin;%PATH%
...
java -jar target/jeyzer-recorder-installer-3.1-SNAPSHOT.jar